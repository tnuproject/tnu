...
#define DE_CP437_U_UMLAUT      0x81
#define DE_CP437_A_UMLAUT      0x84
#define DE_CP437_A_UMLAUT_CAP  0x8e
#define DE_CP437_O_UMLAUT      0x94
#define DE_CP437_O_UMLAUT_CAP  0x99
#define DE_CP437_U_UMLAUT_CAP  0x9a
#define DE_CP437_SHARP_S       0xe1

static const char de_normal_map[128] = {
    [0x01] = 27,  [0x02] = '1', [0x03] = '2', [0x04] = '3', [0x05] = '4',
    [0x06] = '5', [0x07] = '6', [0x08] = '7', [0x09] = '8', [0x0a] = '9',
    [0x0b] = '0', [0x0c] = DE_CP437_SHARP_S, [0x0d] = '\'',
    [0x0e] = '\b', [0x0f] = '\t', [0x10] = 'q', [0x11] = 'w',
    [0x12] = 'e', [0x13] = 'r', [0x14] = 't', [0x15] = 'z',
    [0x16] = 'u', [0x17] = 'i', [0x18] = 'o', [0x19] = 'p',
    [0x1a] = DE_CP437_U_UMLAUT, [0x1b] = '+', [0x1c] = '\n',
    [0x1e] = 'a', [0x1f] = 's', [0x20] = 'd', [0x21] = 'f',
    [0x22] = 'g', [0x23] = 'h', [0x24] = 'j', [0x25] = 'k',
    [0x26] = 'l', [0x27] = DE_CP437_O_UMLAUT, [0x28] = DE_CP437_A_UMLAUT,
    [0x29] = '^', [0x2b] = '#', [0x2c] = 'y', [0x2d] = 'x',
    [0x2e] = 'c', [0x2f] = 'v', [0x30] = 'b', [0x31] = 'n',
    [0x32] = 'm', [0x33] = ',', [0x34] = '.', [0x35] = '-',
    [0x39] = ' ', [0x56] = '<',
};

static const char de_shift_map[128] = {
    [0x01] = 27,  [0x02] = '!', [0x03] = '"', [0x04] = '#', [0x05] = '$',
    [0x06] = '%', [0x07] = '&', [0x08] = '/', [0x09] = '(', [0x0a] = ')',
    [0x0b] = '=', [0x0c] = '?', [0x0d] = '`', [0x0e] = '\b',
    [0x0f] = '\t', [0x10] = 'Q', [0x11] = 'W', [0x12] = 'E',
    [0x13] = 'R', [0x14] = 'T', [0x15] = 'Z', [0x16] = 'U',
    [0x17] = 'I', [0x18] = 'O', [0x19] = 'P', [0x1a] = DE_CP437_U_UMLAUT_CAP,
    [0x1b] = '*', [0x1c] = '\n', [0x1e] = 'A', [0x1f] = 'S',
    [0x20] = 'D', [0x21] = 'F', [0x22] = 'G', [0x23] = 'H',
    [0x24] = 'J', [0x25] = 'K', [0x26] = 'L', [0x27] = DE_CP437_O_UMLAUT_CAP,
    [0x28] = DE_CP437_A_UMLAUT_CAP, [0x29] = '`', [0x2b] = '\'',
    [0x2c] = 'Y', [0x2d] = 'X', [0x2e] = 'C', [0x2f] = 'V',
    [0x30] = 'B', [0x31] = 'N', [0x32] = 'M', [0x33] = ';',
    [0x34] = ':', [0x35] = '_', [0x39] = ' ', [0x56] = '>',
};

static const char de_altgr_map[128] = {
    [0x10] = '@', [0x08] = '{', [0x09] = '[', [0x0a] = ']',
    [0x0b] = '}', [0x0c] = '\\', [0x1b] = '~', [0x56] = '|',
};

static const char de_altgr_shift_map[128] = {
    [0x10] = '@', [0x08] = '{', [0x09] = '[', [0x0a] = ']',
    [0x0b] = '}', [0x0c] = '\\', [0x1b] = '~', [0x56] = '|',
};
...
static char layout_char(uint8_t scancode)
{
    ...
    if (strcmp(layout, "de") == 0) {
        if (altgr_down) {
            char c = shift_down ? de_altgr_shift_map[scancode] : de_altgr_map[scancode];
            if (c) {
                return c;
            }
        }
        return shifted_with_caps(de_normal_map[scancode], de_shift_map[scancode]);
    }
...
{
    return "us uk de fr it es nl lt pl dvorak";
}
